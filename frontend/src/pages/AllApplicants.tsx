...
export default function AllApplicants() {
  ...
  const filtered = useMemo(() => {
    ...
    return applicants.filter(a => {
      if (search.trim()) {
        ...
        if (![a.full_name, a.email, a.headline ?? ""].some(f => f.toLowerCase().includes(q))) return false;
      }
  ...
  }, [applicants, search, selectedSkills, bookmarkedOnly, savedIds, lastSeenFilter]);

  const hasActiveFilter = !!search || selectedSkills.size > 0 || bookmarkedOnly || !!lastSeenFilter;
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          ...
          <p className="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
            Browse and bookmark candidates across all your job listings.
          </p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="relative flex-1 min-w-35">
                ...
                >
                  <option value="">Active Within: All</option>
              ...
              {hasActiveFilter && (
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-2 text-xs font-medium rounded-xl border border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors shrink-0"
                >
                  ...
                  <div className="flex flex-wrap items-center gap-x-2 gap-y-0.5 text-xs text-gray-400 dark:text-gray-500 mb-3">
                    ...
                    <span className="flex items-center gap-1 w-full mt-0.5">
                      <span className={`inline-block w-1.5 h-1.5 rounded-full shrink-0 ${
                        applicant.last_login && Date.now() - new Date(applicant.last_login).getTime() < 7 * 24 * 60 * 60 * 1000
                          ? "bg-emerald-400"
