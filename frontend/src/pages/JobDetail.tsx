    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-200">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <Link
            to="/jobs"
            className="mt-6 inline-flex items-center gap-1.5 text-sm text-teal-600 dark:text-teal-400 hover:underline"
          >
            ← Back to all jobs
          </Link>
        </main>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {job.description && (
              <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
                ...
                <div
                  className="prose-editor text-sm text-gray-600 dark:text-gray-400"
              ...
              <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1 text-xs font-medium rounded-full bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400 border border-teal-100 dark:border-teal-800"
                    >
                      {skill}
                    </span>
                  ))}
          ...
          <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  {isAuthenticated ? (
                    ...
                    <Link
                      to="/login"
                      className="text-sm font-medium text-teal-600 dark:text-teal-400 hover:underline mt-0.5 block"
                    >
            ...
            {!isAuthenticated && (
              <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-100 dark:border-teal-800 rounded-2xl p-4 text-center">
                ...
                <p className="text-xs text-teal-600 dark:text-teal-400 mt-1 mb-3">
                  Create a free account to apply for jobs.
                </p>
                <Link
                  to="/register"
                  className="inline-block px-4 py-1.5 text-xs font-medium rounded-lg bg-teal-600 hover:bg-teal-700 text-white transition-colors"
                >
                  Create Account
                </Link>
              </div>
